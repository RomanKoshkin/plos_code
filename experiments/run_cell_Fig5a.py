...
grid = pd.read_csv('grid_Fig5a.csv', engine='python')
...
UU = np.ones((N,))  # NOTE: make sure that you have EXACTLY the same UU across all the sims and ones for inhib
UU[:NE] = simple_make_UU(NE, case, wide)
...
m.save_state(cell_id, path="data_Fig5a/states")